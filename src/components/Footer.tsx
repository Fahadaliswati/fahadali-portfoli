  ...
  const socialLinks = [
    {
      ...
      url: 'https://github.com/Fahadaliswati',
    ...
    },
    {
      ...
      url: 'https://www.linkedin.com/in/fahad-alikhan/',
    ...
    },
    {
      ...
      url: 'mailto:fahadali.hk0009@gmail.com',
            ...
            <div className="flex space-x-4">
              {socialLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.url}
                  className={`w-10 h-10 bg-secondary rounded-lg flex items-center justify-center ${link.hoverColor} hover:scale-110 transition-smooth group`}
                  title={link.name}
                >
                  <span className="text-muted-foreground group-hover:text-white transition-smooth">
                    {link.icon}
                  </span>
                </a>
              ))}
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-1">
                ...
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
                  <path d="m8.286 10.578.512-8.657a.306.306 0 0 1 .247-.284L17.377.006a.306.306 0 0 1 .353.385l-1.558 5.403a.306.306 0 0 0 .352.385l2.388-.46a.306.306 0 0 1 .332.438l-6.79 13.55-.123.19a.294.294 0 0 1-.252.14.289.289 0 0 1-.24-.127l-2.35-3.434-.013-.02L8.038 10.944a.306.306 0 0 1 .248-.366Z" fill="url(#a)" />
                  <path d="m15.974 2.268-2.487.477a.306.306 0 0 0-.248.366l1.437 5.528a.306.306 0 0 1-.352.385l-4.77-.97a.306.306 0 0 0-.332.438l5.124 10.21a.294.294 0 0 0 .252.14.289.289 0 0 0 .24-.127l5.957-9.462a.306.306 0 0 0-.332-.438l-4.136.8a.306.306 0 0 1-.353-.385l.558-5.877a.306.306 0 0 0-.247-.284l-.31-.06Z" fill="url(#b)" />
                  <defs>
